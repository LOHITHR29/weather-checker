...
function requestApi(city){
    const apiKey = 'c80c6ee89d77e77e37857d06f0510b51';
...
function weatherDetails(info){
    if(info.cod == "404"){ // if user entered city name isn't valid
        ...
        weatherPart.querySelector(".temp .numb").innerText = Math.floor(temperatureCelsius);
        weatherPart.querySelector(".weather").innerText = description;
        weatherPart.querySelector(".location span").innerText = `${city}, ${country}`;
        weatherPart.querySelector(".temp .numb-2").innerText = Math.floor(feelsLikeCelsius);
